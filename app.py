...
if "tax" not in st.session_state:
    st.session_state.tax = data.get("tax", 0.0)
...
if "nj_tire_tax" not in st.session_state:
    st.session_state.nj_tire_tax = data.get("nj_tire_tax", 0.0)

if "disposal_fee" not in st.session_state:
    st.session_state.disposal_fee = data.get("disposal_fee", 0.0)

if "start_price" not in st.session_state:
    st.session_state.start_price = data.get("start_price", 0)

if "end_price" not in st.session_state:
    st.session_state.end_price = data.get("end_price", 0)

if "interval" not in st.session_state:
    st.session_state.interval = data.get("interval", 0)
